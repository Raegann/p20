	...
	<div class="rvs-item-container">
		<div class="rvs-item-stage">
			...
			<div class="rvs-item" style="background-image: url(<?php echo $attachment->url; ?>)">
				...
				<a href="<?php echo foogallery_video_get_video_url_from_attachment( $attachment ); ?>" class="rvs-play-video"></a>
			</div>
			<?php } ?>
	...
	<div class="rvs-nav-container">
		...
		<div class="rvs-nav-stage">
			...
			<a class="rvs-nav-item">
				<span class="rvs-nav-item-thumb" style="background-image: url(<?php echo foogallery_video_get_video_thumbnail_from_attachment( $attachment ); ?>"></span>
